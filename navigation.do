qui {
	...
	if 7 {
		...
		*/
		...
		noi di " "
		noi di "Survey Questions: "
		noi di "Please use any blank line on the excel sheet and ignore the id variable"
		noi di "Q1: Please enter the run time for prompt-based approach: "
		noi di "Q2: Please enter the run time for syntax-based approach: "
		noi di "Q3: Please indicate which approach you felt to be easier to achieve the analytic goal"
		noi di "		1 - Prompt-Based Approach"
		noi di "		2 - Syntax-Based Approach"
		noi di "Q4: Please indicate how many years you have used Stata: "
		noi di "		1 - <1 year"
		noi di "		2 - 1-3 years"
		noi di "		3 - 3-5 years"
		noi di "		4 - >5 years"
		noi di "Q5: Please indicate how you would rate your familarity with Stata: "
		noi di "		1 - Beginner"
		noi di "		2 - Intermediate"
		noi di "		3 - Advanced"
		noi di "		4 - Expert"
		noi di "Q6: Please indicate how long you have used other programming language or statistical software"
		noi di "    (R, Python, C/C++, Java, HTML, SAS, and etc.)"
		noi di "		1 - <1 year"
		noi di "		2 - 1-3 years"
		noi di "		3 - 3-5 years"
		noi di "		4 - >5 years"
